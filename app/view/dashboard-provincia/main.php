  ...
  <div class="container-fluid py-4">
    <div class="row mt-4">
      <div class="col-lg-6">
        ...
        <p class="d-none">We’re constantly trying to express ourselves and actualize our dreams. If you have the opportunity to play.</p>
      </div>
      <?php 
        $url = $_GET['url'];
      ...
      <div class="col-lg-5">
        <div class="card z-index-2">
          <div class="card-header p-3 pt-2">
            ...
            <h5 class="mb-0">Concessões na Província</h5>
