<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ps ps--active-y">
  ...
  <div class="container-fluid py-4">
    <div class="row mt-4">
      ...
      <button type="button" class="btn btn-outline-primary me-3 ms-auto">Baixar Conteúdo</button>
          ...
          <div class="card-body pt-4 p-3">
            ...
            <ul class="list-group">
              <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                <div class="d-flex align-items-center">
                  <div class="d-flex flex-column">
                    <h6 class="mb-1 text-dark text-sm">DOCUMENTO LEGAL</h6>
                    <?php if($key['documento_legal'] != ''): ?>
                      <span class="text-xs"><?= $key['documento_legal']; ?></span>
                    <?php else: ?>
                  ...
                  <?php if($key['documento_legal'] != ''): ?>
                    <a href="<?= DIRPAGE; ?>public/arquivos/documento_legal/<?= $key['documento_legal']; ?>" class="btn btn-icon-only btn-rounded btn-outline-danger mb-0 ms-auto p-3 btn-sm d-flex align-items-center justify-content-center" download="<?= $key['documento_legal']; ?>">
              ...
              <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                <div class="d-flex align-items-center">
                  <div class="d-flex flex-column">
                    <h6 class="mb-1 text-dark text-sm">CARTA AO MINISTRO</h6>
                  ...
                  <?php if($key['carta_ministro'] != ''): ?>
                    <a href="<?= DIRPAGE; ?>public/arquivos/carta_ministro/<?= $key['carta_ministro']; ?>" class="btn btn-icon-only btn-rounded btn-outline-danger mb-0 ms-auto p-3 btn-sm d-flex align-items-center justify-content-center" download="<?= $key['carta_ministro']; ?>">
                      <i class="material-icons text-lg">download</i>
                    </a>
                  <?php else: ?>
                    <button class="btn btn-icon-only btn-rounded btn-outline-dark mb-0 ms-auto p-3 btn-sm d-flex align-items-center justify-content-center disabled">
              ...
              <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                <div class="d-flex align-items-center">
                  ...
                  <?php if($key['carta_conforto_anrm'] != ''): ?>
                    <a href="<?= DIRPAGE; ?>public/arquivos/carta_conforto_anrm/<?= $key['carta_conforto_anrm']; ?>" class="btn btn-icon-only btn-rounded btn-outline-danger mb-0 ms-auto p-3 btn-sm d-flex align-items-center justify-content-center" download="<?= $key['carta_conforto_anrm']; ?>">
                      <i class="material-icons text-lg">download</i>
                    </a>
                  <?php else: ?>
                    <button class="btn btn-icon-only btn-rounded btn-outline-dark mb-0 ms-auto p-3 btn-sm d-flex align-items-center justify-content-center disabled">
              ...
              <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                <div class="d-flex align-items-center">
                  ...
                  <?php if($key['croquis_localizacao'] != ''): ?>
                    <a href="<?= DIRPAGE; ?>public/arquivos/croquis_localizacao/<?= $key['croquis_localizacao']; ?>" class="btn btn-icon-only btn-rounded btn-outline-danger mb-0 ms-auto p-3 btn-sm d-flex align-items-center justify-content-center" download="<?= $key['croquis_localizacao']; ?>">
                      <i class="material-icons text-lg">download</i>
                    </a>
                  <?php else: ?>
                    <button class="btn btn-icon-only btn-rounded btn-outline-dark mb-0 ms-auto p-3 btn-sm d-flex align-items-center justify-content-center disabled">
              ...
              <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                <div class="d-flex align-items-center">
                  <div class="d-flex flex-column">
                    <h6 class="mb-1 text-dark text-sm">DECLARAÇÃO DE CAPACIDADE FINANCEIRA DA EMPRESA</h6>
                  ...
                  <?php if($key['declaracao_capacidade_empresa'] != ''): ?>
                    <a href="<?= DIRPAGE; ?>public/arquivos/declaracao_capacidade_empresa/<?= $key['declaracao_capacidade_empresa']; ?>" class="btn btn-icon-only btn-rounded btn-outline-danger mb-0 ms-auto p-3 btn-sm d-flex align-items-center justify-content-center" download="<?= $key['declaracao_capacidade_empresa']; ?>">
                      <i class="material-icons text-lg">download</i>
                    </a>
                  <?php else: ?>
                    <button class="btn btn-icon-only btn-rounded btn-outline-dark mb-0 ms-auto p-3 btn-sm d-flex align-items-center justify-content-center disabled">
              ...
              <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                <div class="d-flex align-items-center">
                  ...
                  <?php if($key['relatorio_contas_economico'] != ''): ?>
                    <a href="<?= DIRPAGE; ?>public/arquivos/relatorio_contas_economico/<?= $key['relatorio_contas_economico']; ?>" class="btn btn-icon-only btn-rounded btn-outline-danger mb-0 ms-auto p-3 btn-sm d-flex align-items-center justify-content-center" download="<?= $key['relatorio_contas_economico']; ?>">
                      <i class="material-icons text-lg">download</i>
                    </a>
                  <?php else: ?>
                    <button class="btn btn-icon-only btn-rounded btn-outline-dark mb-0 ms-auto p-3 btn-sm d-flex align-items-center justify-content-center disabled">
              ...
              <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                <div class="d-flex align-items-center">
                  ...
                  <?php if($key['programa_trabalho_investimentos'] != ''): ?>
                    <a href="<?= DIRPAGE; ?>public/arquivos/programa_trabalho_investimentos/<?= $key['programa_trabalho_investimentos']; ?>" class="btn btn-icon-only btn-rounded btn-outline-danger mb-0 ms-auto p-3 btn-sm d-flex align-items-center justify-content-center" download="<?= $key['programa_trabalho_investimentos']; ?>">
                      <i class="material-icons text-lg">download</i>
                    </a>
                  <?php else: ?>
                    <button class="btn btn-icon-only btn-rounded btn-outline-dark mb-0 ms-auto p-3 btn-sm d-flex align-items-center justify-content-center disabled">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="row mt-4">
              ...
              <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                <div class="input-group input-group-static">
                  <label class="text-sm fw-bold text-uppercase">Data de Criação da Denominação</label>
                  <div class="form-control w-100 text-lg fw-bold" aria-describedby="emailHelp" onfocus="focused(this)" onfocusout="defocused(this)">
                    <?php 
                      if($key['data_criacao_denominacao'] != '')
                      {
                        echo formatar_data($key['data_criacao_denominacao']); 
                      }else {
                        echo 'Indisponivel';
                      }
                    ?>
            ...
            <div class="row mt-4">
              ...
              <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                <div class="input-group input-group-static">
                  <label class="text-sm fw-bold text-uppercase">Contacto</label>
                  <div class="form-control w-100 text-lg fw-bold" aria-describedby="emailHelp" onfocus="focused(this)" onfocusout="defocused(this)">
                    <?php 
                      if($key['contacto'] != '')
                      {
            ...
            <div class="row mt-4">
              <div class="col-12 col-sm-6">
                <div class="input-group input-group-static">
                  <label class="text-sm fw-bold text-uppercase">1° Socio</label>
                  <div class="form-control w-100 text-lg fw-bold" aria-describedby="emailHelp" onfocus="focused(this)" onfocusout="defocused(this)">
                    <?php 
                      if($key['socio1'] != '')
                      {
              ...
              <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                <div class="input-group input-group-static">
                  <label class="text-sm fw-bold text-uppercase">2° Socio</label>
                  <div class="form-control w-100 text-lg fw-bold" aria-describedby="emailHelp" onfocus="focused(this)" onfocusout="defocused(this)">
                    <?php 
                      if($key['socio2'] != '')
                      {
                        ...
                        <td>
                          <div class="d-flex px-2 py-0">
                            ...
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm">Homens Nacionais</h6>
                            </div>
                          </div>
                        </td>
                      ...
                      <tr class="coluna">
                        <td>
                          <div class="d-flex px-2 py-0">
                            ...
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm">Homens Estrageiros</h6>
                            </div>
                          </div>
                        </td>
                        <td class="align-middle text-center text-sm">
                      ...
                      <tr class="coluna">
                        <td>
                          <div class="d-flex px-2 py-0">
                            ...
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm">Mulheres Nacionais</h6>
                            </div>
                          </div>
                        </td>
                        <td class="align-middle text-center text-sm">
                      ...
                      <tr class="coluna">
                        <td>
                          <div class="d-flex px-2 py-0">
                            ...
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm">Mulheres Estrageiros</h6>
                            </div>
                          </div>
                        </td>
                        <td class="align-middle text-center text-sm">
          ...
          <div class="col-12">
            <div class="card h-100 mb-4">
              <div class="card-header pb-0 px-3">
                <div class="row">
                  <div class="col-md-6">
                    <h4 class="mb-0 text-uppercase">Capacidades</h4>
                  </div>
              ...
              <div class="card-body pt-4 p-3">
                ...
                <ul class="list-group">
                  <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                    <div class="d-flex align-items-center">
                      <div class="d-flex flex-column">
                        <h6 class="mb-1 text-dark text-sm">CAPACIDADE TECNICA</h6>
                        <?php if($key['capacidade_tecnica'] != ''): ?>
                          <span class="text-xs"><?= $key['capacidade_tecnica']; ?></span>
                        <?php else: ?>
                          <span class="text-xs">Sem Arquivo</span>
                        <?php endif; ?>
                      </div>
                      ...
                      <?php if($key['capacidade_tecnica'] != ''): ?>
                        <a href="<?= DIRPAGE; ?>public/arquivos/capacidade_tecnica/<?= $key['capacidade_tecnica']; ?>" class="btn btn-icon-only btn-rounded btn-outline-danger mb-0 ms-auto p-3 btn-sm d-flex align-items-center justify-content-center" download="<?= $key['capacidade_tecnica']; ?>">
                          <i class="material-icons text-lg">download</i>
                        </a>
                      <?php else: ?>
                        <button class="btn btn-icon-only btn-rounded btn-outline-dark mb-0 ms-auto p-3 btn-sm d-flex align-items-center justify-content-center disabled">
                  ...
                  <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                    <div class="d-flex align-items-center">
                      <div class="d-flex flex-column">
                        <h6 class="mb-1 text-dark text-sm">CAPACIDADE FINANCEIRA</h6>
                        <?php if($key['capacidade_financeira'] != ''): ?>
                          <span class="text-xs"><?= $key['capacidade_financeira']; ?></span>
                        <?php else: ?>
                          <span class="text-xs">Sem Arquivo</span>
                        <?php endif; ?>
                      </div>
                      ...
                      <?php if($key['capacidade_financeira'] != ''): ?>
                        <a href="<?= DIRPAGE; ?>public/arquivos/capacidade_financeira/<?= $key['capacidade_financeira']; ?>" class="btn btn-icon-only btn-rounded btn-outline-danger mb-0 ms-auto p-3 btn-sm d-flex align-items-center justify-content-center" download="<?= $key['capacidade_financeira']; ?>">
                          <i class="material-icons text-lg">download</i>
                        </a>
                      <?php else: ?>
                        <button class="btn btn-icon-only btn-rounded btn-outline-dark mb-0 ms-auto p-3 btn-sm d-flex align-items-center justify-content-center disabled">
      ...
      <div class="col-sm-7 mt-sm-0 mt-4">
        <div class="card">
          <div class="card-header p-3 pt-2">
            ...
            <h4 class="font-weight-bolder">TÍTULO MINERAL</h4>
          </div>
          <div class="card-body">
            <?php foreach($params['concessao'] as $key): ?>
            <div class="row mt-4">
              <div class="col-12 col-sm-6">
                <div class="input-group input-group-static">
                  <label class="text-sm fw-bold text-uppercase">TÍTULO MINERAL</label>
                  <div class="form-control w-100 text-lg fw-bold" aria-describedby="emailHelp" onfocus="focused(this)" onfocusout="defocused(this)">
                    <?php 
            ...
            <div class="row mt-4">
              ...
              <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                <div class="input-group input-group-static">
                  <label class="text-sm fw-bold text-uppercase">Data de Validade Do Título</label>
                  <div class="form-control w-100 text-lg fw-bold" aria-describedby="emailHelp" onfocus="focused(this)" onfocusout="defocused(this)">
                    <?php 
            ...
            <div class="row mt-4">
              ...
              <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                <div class="input-group input-group-static">
                  <label class="text-sm fw-bold text-uppercase">Data de Caducidade Do Código</label>
                  <div class="form-control w-100 text-lg fw-bold" aria-describedby="emailHelp" onfocus="focused(this)" onfocusout="defocused(this)">
                    <?php 
                      if($key['data_caducidade_codigo'] != '')
                      {
                        echo formatar_data($key['data_caducidade_codigo']);
                      }else {
                        echo 'Indisponivel';
                      }
                    ?>
            ...
            <div class="row mt-4">
              ...
              <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                <div class="input-group input-group-static">
                  <label class="text-sm fw-bold text-uppercase">Data da Rubrica Dos Contratos</label>
                  <div class="form-control w-100 text-lg fw-bold" aria-describedby="emailHelp" onfocus="focused(this)" onfocusout="defocused(this)">
                    <?php 
      ...
      <div class="col-sm-6">
        <div class="card">
          <div class="card-header p-3 pt-2">
            ...
            <h4 class="font-weight-bolder text-uppercase">Bónus Por Prestação</h4>
          </div>
          <div class="card-body">
            <?php foreach($params['concessao'] as $key): ?>
            <div class="row mt-4">
              <div class="col-12 col-sm-6">
                <div class="input-group input-group-static">
                  <label class="text-sm fw-bold text-uppercase">1° Prestação</label>
              ...
              <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                <div class="input-group input-group-static">
                  <label class="text-sm fw-bold text-uppercase">2° Prestação</label>
                  <div class="form-control w-100 text-lg fw-bold" aria-describedby="prestacao1" onfocus="focused(this)" onfocusout="defocused(this)">
                    <?php 
                      if($key['prestacao_1'] != '')
                      {
            ...
            <div class="row mt-4">
              <div class="col-12 col-sm-6">
                <div class="input-group input-group-static">
                  <label class="text-sm fw-bold text-uppercase">3° Prestação</label>
              ...
              <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                <div class="input-group input-group-static">
                  <label class="text-sm fw-bold text-uppercase">4° Prestação</label>
            ...
            <div class="row mt-4">
              <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                <div class="input-group input-group-static">
                  <label class="text-sm fw-bold text-uppercase">5° Prestação</label>
